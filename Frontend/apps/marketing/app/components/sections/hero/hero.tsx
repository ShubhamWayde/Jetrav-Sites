        ...
        <div className={clx('flex', 'flex-col', 'gap-8')}>
          ...
          <div className={clx(styles.headingWrapper, 'flex', 'flex-col', 'gap-4')}>
            <h1 className={clx(fontRoboto.className)}>
              <span className={clx(styles.heroIconWrapper, 'inline-flex', 'item-center', 'gap-6')}>
                Travel Seamlessly{' '}
                <Icon icon={FlightTakeoff} color={'secondary'} className={styles.heroIcon} />
              </span>
              <span className={clx(styles.heroIconWrapper, 'inline-flex', 'item-center', 'gap-6')}>
                Earn Instantly
                <Icon icon={CurrencyRupeeCircle} color={'secondary'} className={styles.heroIcon} />
              </span>
              <span className={clx(styles.heroIconWrapper, 'inline-flex', 'item-center', 'gap-6')}>
                Manage Effortlessly{' '}
                <Icon icon={Workspaces} color={'secondary'} className={styles.heroIcon} />
              </span>
            </h1>
            <p className={clx('paragraph', 'text-start')}>
              The only travel agency that gives you <em>15%</em> back in Jet Points on every flight
              and manages your entire trip starting at <em>₹199</em>.
            </p>
          </div>
