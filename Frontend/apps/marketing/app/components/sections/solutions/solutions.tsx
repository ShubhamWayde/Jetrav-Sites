...
const DATA = [
  {
    id: "1",
    icon: (
      <Icon icon={AirplaneTicket} size={"xxl"} color={"secondaryGradient"} />
    ),
    title: "Air Tickets",
    description:
      "Domestic and International flights with maximum reward points.",
  },
  {
    id: "2",
    ...
    title: "Hotels",
    description:
      "From budget stays to luxury suites, tailored to your preference.",
  },
  {
    id: "3",
  ...
  },
  {
    id: "7",
    icon: (
      <Icon icon={CurrencyExchange} size={"xxl"} color={"secondaryGradient"} />
    ),
  ...
  },
  {
    ...
    description:
      "Customized itineraries for families, couples, and solo travelers.",
  },
  {
    id: "9",
    ...
    description:
      "Need a wheelchair, extra baggage, or a special meal? We ensure the airline knows before you fly.",
  },
];
      ...
      <div className={clx("container")}>
        <div>
          <InfoBlock
            ...
            description={
              "We don't just book tickets; we curate experiences.\n" +
