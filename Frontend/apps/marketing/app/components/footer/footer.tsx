  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        icon: (
          <Icon icon={Registration} size={"lg"} color={"secondaryGradient"} />
        ),
      },
      {
        ...ROUTES.publicApp.trackBooking,
        icon: (
          <Icon icon={TrackBooking} size={"lg"} color={"secondaryGradient"} />
        ),
      },
    ],
  },
      ...
      <div className={clx("container")}>
        ...
        >
          ...
          >
            ...
            >
              <Link
                ...
                href={"https://www.instagram.com/jetravhq/"}
                target={"_blank"}
              >
                <Icon
                  icon={Instagram}
          ...
          <div className={clx(styles.footerLinks)}>
            <div
              className={clx("grid", "grid-cols-3", "sm-grid-cols-1", "gap-6")}
            >
