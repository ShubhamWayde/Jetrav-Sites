...
export const Button = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonPropsWithAs>(
  (props, ref) => {
    const { children, variant = 'primary', icon, className, disabled, ...rest } = props;
