/**
 * Icons.tsx — Centralised SVG icon library.
 * All icons are stroke-based, use `currentColor`, and accept a `size` prop
 * (default 16) so they scale to any context without extra CSS.
 *
 * Usage:
 *   import { TrashIcon, PencilIcon } from '@repo/ui/Icons';
 *   <TrashIcon size={18} />
 */
...
// ── Leads / Target ────────────────────────────────────────────────────────────
export function LeadsIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
